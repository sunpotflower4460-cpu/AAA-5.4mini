...
export function EmptyState({ title, subtitle, actionLabel, onAction, compact = false }: EmptyStateProps) {
  return (
    <div className={`flex flex-col items-center justify-center gap-5 px-5 text-center text-[color:var(--color-ink-muted)] ${compact ? 'min-h-[34dvh] py-8' : 'min-h-[48dvh] py-10'}`}>
